...
$(_endef)
	...
	# release rom: change lua script to byte code
	if [ "$(ROM_BUILD_TYPE)" == "release" -o "$(ROM_BUILD_TYPE)" == "research" -o "$(ROM_BUILD_TYPE)" == "alpha" ]; then \
		$(SCRIPT_DIR)/rluac.sh $$(IDIR_$(1)) $(STAGING_DIR_HOSTPKG)/bin/luac; \
	fi

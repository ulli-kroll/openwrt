...
class SigningPackage(object):
    ...
    def _initialize(self, hash_to_sign, data_to_sign, image_path, signing_package_file, signing_attributes):
        ...
        self.request = get_signing_request_class(signing_attributes.cass_capability, signing_attributes.secboot_version)(hash_to_sign, data_to_sign, image_path, signing_attributes)

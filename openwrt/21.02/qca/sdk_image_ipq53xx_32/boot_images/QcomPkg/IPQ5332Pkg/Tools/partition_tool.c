...
*   order.
*
*   $Header: //components/dev/boot.xf/0.3.1.1/priyma.boot.xf.0.3.1.1.initial_change/QcomPkg/IPQ9574Pkg/Tools/partition_tool.c#1 $ $DateTime: 2022/03/07 01:02:20 $ $Author: priyma $
*

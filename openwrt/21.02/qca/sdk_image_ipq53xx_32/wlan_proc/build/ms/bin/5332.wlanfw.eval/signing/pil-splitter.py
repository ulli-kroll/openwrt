...
def append_data(input, output, start, size):
	...
	if size == 0:
		...
		#The below change is to pad zeroes to provide alignment to the program headers as per the size mentioned in the mbn.
		#This is a requirement from TME to create SPLIT MBN with such alignment from IPQ5332

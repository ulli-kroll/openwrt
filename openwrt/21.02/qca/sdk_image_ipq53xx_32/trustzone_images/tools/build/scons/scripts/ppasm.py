...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.tzw/1.0/build/scons/scripts/ppasm.py#2 $
#  $DateTime: 2019/05/30 03:21:35 $
#  $Author: pwbldsvc $
#  $Change: 19363857 $
...
def main():
   ...
   if options.output_filename is None:
      ...
      exists = os.path.isfile(options.output_filename)
      if exists:
        try: 
          os.chmod(options.output_filename, 0755)
        except:
          pass

...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.tzw/1.0/build/scons/build/build.py#1 $
#  $DateTime: 2018/09/05 05:45:12 $
#  $Change: 17044639 $
#
#===============================================================================
...
def build (*args):
   ...
   try:
      ...
      lg.log("Running $Header: //components/rel/scons.tzw/1.0/build/scons/build/build.py#1 $")

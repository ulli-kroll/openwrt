...
#
# Copyright (c) 2009-2013,2021,2023 by Qualcomm Technologies, Incorporated.
# All Rights Reserved.
# QUALCOMM Proprietary/GTDR
#
#----------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.tzw/1.0/build/scons/scripts/version_builder.py#3 $
#  $DateTime: 2023/04/24 06:45:49 $
#  $Author: pwbldsvc $
#  $Change: 46128888 $
# 
...
# ----------   ---     ---------------------------------------------------------
# 2023-04-24   abilj    Declare TZ strings with const to move it to RO regions.
# 2021-12-02   abisrs   image uuid updation for crashscope tool
# 
#============================================================================
import os
import re

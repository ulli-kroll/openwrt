...
typedef enum {
  ...
  TEE_SC_CR_MAC              = 0x11,  // Command, Response APDUs shall be MAC protected
  ...
  TEE_SC_R_ENC_MAC           = 0x30,  // Response APDU shall be encrypted and MAC protected
  TEE_SC_CR_ENC_MAC          = 0x33,  // Command, Response APDUs encrypted, MAC protected
...
/**
 *  Key ID and Key version values for SCP
 */
#define TEE_KID_SCP11a_PKCAKLOCECDSA            0x10
#define TEE_KID_SCP11a_SKSDECKA                 0x11
#define TEE_KID_SCP11a_KEYDEK                   0x12
#define TEE_KID_SCP11b_SKSDECKA                 0x13
#define TEE_KID_SCP11b_KEYDEK                   0x14
#define TEE_KID_SCP11a_ADDPKCAKLOCECDSA_START   0x20
#define TEE_KID_SCP11a_ADDPKCAKLOCECDSA_END     0x2F

...
*/
/*===========================================================================
   Copyright (c) 2011,2023 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/

/*===========================================================================

                            EDIT HISTORY FOR FILE
  $Header: //components/rel/ssg.tzw/1.2/securemsm/trustzone/qsapps/common/crypto_test_vectors/crypto_ecc_test_vectors.h#2 $
  $DateTime: 2023/07/28 01:15:31 $
  $Author: pwbldsvc $

# when       who     what, where, why
# --------   ---     ---------------------------------------------------------
7/28/2023   hk       Added ECDSA specific structures
...
typedef struct
{
   ...
   char   *n;
   uint32_t key_size;         //size in bits
} __attribute__ ((packed)) generic_ecc_curve_params_type;


static generic_ecc_curve_params_type generic_ecc_curve_parameters[] =
{
   { //Key length 160 bits

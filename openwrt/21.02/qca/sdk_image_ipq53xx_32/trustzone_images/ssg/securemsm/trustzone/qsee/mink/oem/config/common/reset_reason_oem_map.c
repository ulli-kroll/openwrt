...
#define TZBSP_ERR_FATAL_HLOS_PANIC                   71
#define TZBSP_ERR_FATAL_RESIN_RST                    72
#define TZBSP_ERR_FATAL_TMEL_ERR                     73
...
#define TZBSP_ERR_FATAL_IPCC                            79
#define TZBSP_ERR_FATAL_SUBSYSTEM_FAILURE               80
#define TZBSP_ERR_FATAL_DCC_INIT                        81 
#define TZBSP_ERR_FATAL_LOG_ENCR_CIPHER_FREE_FAILED     82
#define TZBSP_ERR_FATAL_MON_SB_FAILED                   103
#define TZBSP_ERR_FATAL_TMEL_VFSM		        104
#define TZBSP_ERR_FATAL_TMEL_WDT		        105
...
static tzbsp_reset_reason_pair_t rst_reason_list[] =
{
  ...
  {TZBSP_ERR_FATAL_HLOS_PANIC                  , 71},
  {TZBSP_ERR_FATAL_RESIN_RST                   , 72},
  {TZBSP_ERR_FATAL_TMEL_ERR                    , 73},
  {TZBSP_ERR_FATAL_MALLOC_FAILED                  , 74},
  {TZBSP_ERR_FATAL_DIAG_LOG_CTX_CREATE_FAILED     , 75},
  {TZBSP_ERR_FATAL_SEC_WDOG_BARK_INT_MASK_FAILED  , 76},
  {TZBSP_ERR_FATAL_INIT_BOOT_TAMPER_CHECK_FAILED  , 77},
  {TZBSP_ERR_FATAL_LK_KERNEL                      , 78},
  {TZBSP_ERR_FATAL_IPCC                           , 79},
  {TZBSP_ERR_FATAL_SUBSYSTEM_FAILURE              , 80},  
  {TZBSP_ERR_FATAL_DCC_INIT                       , 81},
  {TZBSP_ERR_FATAL_LOG_ENCR_CIPHER_FREE_FAILED    , 82},
  {TZBSP_ERR_FATAL_MON_SB_FAILED                  , 103},
  {TZBSP_ERR_FATAL_TMEL_VFSM		      	  , 104},
  {TZBSP_ERR_FATAL_TMEL_WDT		      	  , 105},

...
/*===========================================================================
  ...
  $Header: //components/rel/ssg.tzw/1.2/securemsm/uclib/usr/legacy/secrsa/shared/inc/secrsa.h#1 $
...
/**
  ...
  @param[in]  key       The private RSA key to use
  @param[in]  padding_type Type of padding (CE_RSA_PAD_PKCS1_V1_5_SIG or NO_PAD)
  @param[in]  padding_info The hash to sign
  @param[in]  hashidx   The index of the hash desired
  @param[in]  sig       The signature
  @param[in]  signlen   The max size and resulting size of the signature
  @param[out] dec_msg   The decrypted message
  @param[in/out]  dec_msg_len   The length of the decrypted msg

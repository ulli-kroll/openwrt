...
Copyright (c) 2000-2011,2022,2023 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/

/*===========================================================================
                      EDIT HISTORY FOR FILE

 $Header: //components/rel/ssg.tzw/1.2/securemsm/uclib/tz/legacy/ce/inc/CeML.h#3 $
 $DateTime: 2023/03/10 06:48:43 $
 $Author: pwbldsvc $

 when       who     what, where, why
 --------   ---     ----------------------------------------------------------
 03/07/23   abs     Added support for AES from TZAPP
 03/10/22   as      Support for h/w key distribution 
...
typedef enum
{
  ...
  CEML_CIPHER_PARAM_DIS_HW_KEY      = 0x18,
  CEML_CIPHER_PARAM_PROD_SEED_KEY          = 0x19,
  CEML_CIPHER_PARAM_CRBK_KEY          = 0x20,

...
/*===========================================================================
  Copyright (c) 2010-2013,2019,2021,2022 by Qualcomm Technologies, Incorporated.
  All Rights Reserved.
...
/*===========================================================================
  ...
  $Header: //components/rel/ssg.tzw/1.2/securemsm/accesscontrol/api/ACCommon.h#4 $
  $DateTime: 2022/12/09 05:41:27 $
  $Author: pwbldsvc $

  when       who     what, where, why
  --------   ---     ----------------------------------------------------------i
  12/08/22   sp      53xx: Updated QDSP and TME VMID in enum
  05/21/21   as      Added PCIE master id 
...
typedef enum
{
    ...
    AC_ERR_INTEGER_OVERFLOW                              = 110,
    AC_ERR_INVALID_RAM_NUM_PARTITION                     = 116,
    AC_ERR_LAST,
...
typedef enum 
{
    AC_VM_NONE                                   = 0,
    AC_VM_RPM                                    = 1,
    AC_VM_TZ                                     = 2,  /* Single stage */
    AC_VM_HLOS                                   = 3,
    AC_VM_TME					 = 4,
#ifndef CHIPSET_53xx // FIXME_90xx: USB0 Conflicting usage with TME VMID Value
    AC_VM_USB0                                   = 4,
#else
    AC_VM_USB0					 = 5,
#endif
    AC_VM_USB1                                   = 5,
    AC_VM_PCIE0                                  = 6,
    AC_VM_ADSP_Q6_ELF                            = 7,   /* Single */ //FIXME_8074: CP vmid in Jacala
    AC_VM_LPASS                                  = 7,   /* Single */ //FIXME_8074: CP vmid in Jacala
#ifndef CHIPSET_53xx
    AC_VM_QDSP                                   = 8,
#else
    AC_VM_QDSP					 = 0,

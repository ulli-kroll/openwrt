...
/*===========================================================================
Copyright (c) 2010-2013,2019,2023 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
============================================================================*/
...
$Header: //components/rel/ssg.tzw/1.2/securemsm/accesscontrol/api/AccessControlTz.h#2 $
$DateTime: 2023/03/09 02:12:57 $
$Author: pwbldsvc $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/07/23   sp      53xx: Add Minimal xPU Support using DEVCFG_NOAC
08/20/19   as      Fix for QPIC Nand MPU
06/11/19   sure    dynamic xpu lock support added
...
typedef struct tzbsp_mpu_rg_s
{
  ...
  uint64 start_upper;  /* Start of the partition. */
  uint64 end_upper;    /* End of the partition, not included in the range */
} tzbsp_mpu_rg_t;
...
typedef enum
{
  ...
  XPU_DISABLE_NON_MSS,
  XPU_DISABLE_ALL,
  XPU_DISABLE_ALL_EXCEPT_TCSR_AND_DDR
} xpu_level_t;

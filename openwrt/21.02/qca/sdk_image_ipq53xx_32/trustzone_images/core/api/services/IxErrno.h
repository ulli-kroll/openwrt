...
Copyright (c) 2000-2009, 2022 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.tzw/1.2/api/services/IxErrno.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/11/2022  as     Added Unique error code to notify key handle out of slot
                   during derive key request
...
typedef enum
{
  ...
  /*** Key Management related error conditions ***/
  E_TMEL_KEY_HANLDE_OUT_OF_SLOT = 300,

...
/*
  ...
  $Header: //components/rel/core.tzw/1.2/api/pmic/pm/pm_npa_vreg.h#1 $
...
typedef struct
{
    ...
    unsigned sw_enable_size; // 4
    unsigned sw_enable_value;
#if 0 //IPQ60XX: Legacy code; Structure is not used entirely
    ...
    unsigned corner_size; // 4
    unsigned corner_value;
#endif //IPQ60XX: Legacy code; not used
} pm_npa_ldo_kvps;

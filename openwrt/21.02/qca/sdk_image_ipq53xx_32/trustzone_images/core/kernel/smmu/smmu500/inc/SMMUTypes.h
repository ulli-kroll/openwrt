...
$Header: //components/rel/core.tzw/1.2/kernel/smmu/smmu500/inc/SMMUTypes.h#1 $
...
--------   ---     ---------------------------------------------------------
01/10/19   gp      Enable Stage 2 bypass; adopt from ipq807x
...
typedef enum
{
	SMMU_DISABLE_NONE, //To enable both SMMU Stage2 and S2CR bypass
	SMMU_DISABLE_S2, //To disable SMMU Stage2 with CLIENTPD=0 (S2CR bypass will be enabled)
	SMMU_DISABLE_ALL, // To disable both SMMU stage2 and S2CR bypass
} smmu_level_t;

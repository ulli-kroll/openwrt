...
def secimage_cfgparser(verbatim_config=False):
    """
    ...
    return CfgParserNamedTuple(
        "2.0", ConfigRulesManager(verbatim_config=verbatim_config),
...
class SecImageConfigParser(ConfigParser):
    ...
    def __init__(self, config_path, overrides=None, spec_overrides=None,
        ...
        self.cfgparser = secimage_cfgparser(verbatim_config=verbatim_config)

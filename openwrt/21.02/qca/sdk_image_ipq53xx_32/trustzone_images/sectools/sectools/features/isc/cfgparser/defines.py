...
from .chipset_profiles import CHIPSET_PROFILES
...
ENUMERATED_ENABLE_DISABLE_HEX64_TYPE = set_enumerated_values(
    ENUMERATED_ENABLE_DISABLE_HEX64_TAG, **{DISABLE: 0, ENABLE: 1, FALSE: 0, TRUE: 1})

ENUMERATED_DISABLE_ENABLE_BOUND_HEX64_TYPE = set_enumerated_values(
    ENUMERATED_DISABLE_ENABLE_BOUND_HEX64_TAG, **{DISABLE: 0, ENABLE: 1, ENABLE_BOUND: 2})
...
MRC_2_0_CHIPSETS = (
    ...
    'sm8250', 'sdx55', 'sm7150', 'nicobar', '9205', '6390', '7605', 'saipan', 'rennell'
)
...
SECBOOT_3_0_DOUBLE_SIGN_CHIPSETS = (
    'sm8150', 'sdx24', 'sc8180x', 'sm6150', 'sm8250', 'sdx55', 'sm7150', 'nicobar', '9205', 'qcs405', 'saipan', 'rennell'
)

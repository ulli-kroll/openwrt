...
g_pci_targets="qcn9000 qcn6122 qcn9160 qcn6432 qcn9224"
...
ftm_qcawifi() {
	...
	[ -f /tmp/sysinfo/sdk_board_name ] && {
		board_name=$(cat /tmp/sysinfo/sdk_board_name)
	}
	...
	if [ -e /sys/firmware/devicetree/base/MP_256 ]; then
		...
		*)
        ...
        if [ $ker_ver -ge 6 ]; then
                ...
                echo "diag-router started" > /dev/kmsg
        fi
